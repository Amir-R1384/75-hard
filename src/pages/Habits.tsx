...
import { Calendar, Habit, Header, PlusButton, WeekCalendar } from '../components'
		...
		<div className="space-y-10">
			...
			<div className="gap-y-3 flex flex-col transition-all">
				...
				<div
					...
					} habit transition-all w-full flex duration-500 justify-between items-center bg-gray-50`}>
					<input
						type="text"
					...
					/>
					<button onClick={addHabit} className="w-6 stroke-dark">
						<CheckmarkIcon />
					</button>
				</div>
			</div>
